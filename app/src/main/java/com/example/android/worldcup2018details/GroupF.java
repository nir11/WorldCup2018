...
public class GroupF extends AppCompatActivity {
    ...
    public void onBackPressed(){
        Intent numbersIntent = new Intent(GroupF.this, MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forwardButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent numbersIntent = new Intent(GroupF.this, GroupG.class);
                startActivity(numbersIntent);
            }
        });
        ...
        backwardButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent numbersIntent = new Intent(GroupF.this, GroupE.class);
                startActivity(numbersIntent);
            }
        });
